...
const changeCurrentPassword = asyncHandler(async (req, res) => {
	...
	return res.status(200).json(ApiResponse(200, {}, "Password changed successfully"))
})
...
const updateAccountDetails = asyncHandler(async (req, res) => {
	...
	if(!fullName || !email){
		throw new ApiError(400, "All fields req required")
...
const updateUserAvatar = asyncHandler( async (req, res) => {
	...
	res.status(200).json(ApiResponse(200, {user}, "avatar uploaded successfully"))
})
